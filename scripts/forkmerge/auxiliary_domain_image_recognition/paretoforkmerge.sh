...
CUDA_VISIBLE_DEVICES=0 python paretoforkmerge.py data/domainnet -d DomainNet -s c i p q r s \
    -t c -a resnet101 --epochs 20 -i 5 --seed 0 \
    --log logs/domainnet/pareto_atl/c
CUDA_VISIBLE_DEVICES=6 python paretoforkmerge.py data/domainnet -d DomainNet -s c i p q r s \
    -t i -a resnet101 --epochs 20 -i 2500 --seed 0 \
    --log logs/DomainNet/Paretoforkmerge/i
CUDA_VISIBLE_DEVICES=1 python paretoforkmerge.py data/domainnet -d DomainNet -s c i p q r s \
    -t p -a resnet101 --epochs 20 -i 2500 --seed 0 \
    --log logs/DomainNet/Paretoforkmerge/p
CUDA_VISIBLE_DEVICES=5 python paretoforkmerge.py data/domainnet -d DomainNet -s c i p q r s \
    -t q -a resnet101 --epochs 20 -i 2500 --seed 0 \
    --log logs/DomainNet/Paretoforkmerge/q
CUDA_VISIBLE_DEVICES=4 python paretoforkmerge.py data/domainnet -d DomainNet -s c i p q r s \
    -t r -a resnet101 --epochs 20 -i 2500 --seed 0 \
    --log logs/DomainNet/Paretoforkmerge/r
CUDA_VISIBLE_DEVICES=0 python paretoforkmerge.py data/domainnet -d DomainNet -s c i p q r s \
    -t s -a resnet101 --epochs 20 -i 2500 --seed 0 \
    --log logs/DomainNet/Paretoforkmerge/s
